...
function RootNavigator() {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="AlbumScreen" component={AlbumScreen} options={{ title: 'aaaaalllllbum screeeeeeeen' }} />
  ...
  return (
    <BottomTab.Navigator
      ...
      */}
        ...
        options={{
          title: 'Library',
          tabBarIcon: ({ color }) => <Ionicons name="library" size={25} color={color} />,
        }}
      />
          <BottomTab.Screen
        name="TabFour"
